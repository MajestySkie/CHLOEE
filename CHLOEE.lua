if (game:GetService("CoreGui")):FindFirstChild("CHLOEE") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).CHLOEE:Destroy();
...
ImageButton.Image = "rbxassetid://98803367684553";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("CHLOEE")).Enabled = not (game.CoreGui:FindFirstChild("CHLOEE")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://98803367684553";
	Title.Parent = Frame;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("CHLOEE") then
			makefolder("CHLOEE");
		end;
		if not isfolder("CHLOEE/Library/") then
			makefolder("CHLOEE/Library/");
		end;
		if not isfile(("CHLOEE/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("CHLOEE/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("CHLOEE/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("CHLOEE/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("CHLOEE/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local CHLOEE = Instance.new("ScreenGui");
	CHLOEE.Name = "CHLOEE";
	CHLOEE.Parent = game.CoreGui;
	CHLOEE.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = CHLOEE;
